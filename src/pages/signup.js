      ...
      <form className="signup" onSubmit={handleSubmit}>
        ...
        <div className="input-container">
          ...
          <input
            ...
            style={{
              borderColor:
                submitted && !validatePassword(password) ? "red" : "initial", // Highlight if invalid after submission
            }}
          />
        </div>
        ...
        <div className="password-requirements">
          <ul>
            {passwordRequirements.map((req, index) => (
              <li
                key={index}
                style={{ color: req.test.test(password) ? "green" : "red" }}
              >
                {req.message}
              </li>
            ))}
        ...
        <div className="input-container">
          ...
          <input
            ...
            style={{
              borderColor:
                submitted && checkNotMatchingPassword(password, confirmPassword)
                  ? "red"
                  : "initial", // Highlight if mismatch after submission
            }}
          />
        </div>
