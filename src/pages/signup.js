            ...
            <form className="signup" onSubmit={handleSubmit}>
                ...
                <div className="input-container">
                    ...
                    <input
                        ...
                        style={{
                            borderColor:
                                submitted && emailError ? 'red' : 'initial', // Highlight if invalid after submission
                        }}
                    />
                </div>
                        ...
                        style={{
                            borderColor:
                                submitted && !validatePassword(password)
                                    ? 'red'
                                    : 'initial', // Highlight if invalid after submission
                        }}
                    />
                </div>
